...
<head>
    ...
    <title>SIMPELKPM - Cetak Laporan 2A</title>
        ...
        <ul class="navbar-nav bg-gradient-success sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                ...
                <div id="collapseThree" class="collapse" aria-labelledby="headingThree" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="" data-toggle="tooltip" data-placement="top" title="Data Pemantauan Bulanan Ibu Hamil">Cetak Laporan 2.A</a>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="panel">
                        ...
                        <h4 class="page-header fw-bolder"><i class="fa fa fa-bars fw-bolder"></i> CETAK LAPORAN 2A PEMANTAUAN BULANAN BAGI IBU HAMIL</h4>
                        </div>
