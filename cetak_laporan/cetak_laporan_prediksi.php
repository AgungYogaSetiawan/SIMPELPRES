...
<head>
    ...
    <title>SIMPELPRES - Cetak Laporan Prediksi Stunting</title>
                    ...
                    <div class="col-lg-12">
                        <div class="card mb-4 mt-2">
                            <div class="card-header py-3">
                                <h6 class="m-0 font-weight-bold text-uppercase">CETAK LAPORAN PREDIKSI STUNTING</h6>
                            </div>
                            <div class="card-body">
                                <form action="cetak_formulir_prediksi.php" method="post" target="_blank">
                                    <table>
                                    <tr>
                                        <td>Tanggal Awal</td>
                                        <td>: 
                                            <input type="date" name="tgl_awal" id="tgl_awal" style="width: 193px;">
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>Sampai Tanggal</td>
                                        <td>: 
                                            <input type="date" name="tgl_akhir" id="tgl_akhir" style="width: 193px;">
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td>:
                                            <select class="form-select select2" name="hasil" id="hasil" style="width: 193px;">
