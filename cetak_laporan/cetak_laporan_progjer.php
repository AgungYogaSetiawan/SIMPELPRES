...
<head>
    ...
    <title>SIMPELPRES - Cetak Laporan Program Kerja Tahunan</title>
                    ...
                    <div class="col-lg-12">
                        <div class="card mb-4 mt-2">
                            <div class="card-header py-3">
                                <h6 class="m-0 font-weight-bold text-uppercase">CETAK LAPORAN PROGRAM KERJA TAHUNAN UNTUK PENCEGAHAN STUNTING</h6>
                            </div>
                            <div class="card-body">
                                <form action="cetak_formulir_progjer.php" method="post" target="_blank">
                                    <table>
                                    <tr>
                                        <td>Tahun</td>
                                        <td>: 
                                    ...
                                    <!-- <tr>
                                        ...
                                        <td>: 
                                            <input type="date" name="tgl_akhir" id="tgl_akhir" placeholder="Waktu Pelaksanaan" style="width: 193px;">
                                        </td>
                                    </tr> -->
