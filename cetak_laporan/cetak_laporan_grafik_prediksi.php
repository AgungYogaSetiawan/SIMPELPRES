...
<head>
    ...
    <title>SIMPELPRES - Cetak Laporan Grafik Hasil Prediksi Stunting</title>
                    ...
                    <div class="col-lg-12">
                        <div class="card mb-4 mt-2">
                            <div class="card-header py-3">
                                <h6 class="m-0 font-weight-bold text-uppercase">CETAK LAPORAN GRAFIK HASIL PREDIKSI STUNTING</h6>
                            </div>
                            <div class="card-body">
                                <form action="cetak_formulir_grafik_prediksi.php" method="post" target="_blank">
                                    <table>
                                    <tr>
                                        <td>Tanggal Awal</td>
                                        <td>: 
