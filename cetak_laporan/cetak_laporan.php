...
<head>
    ...
    <title>SIMPELKPM - Cetak Laporan</title>
...
<body id="page-top">
        ...
        <ul class="navbar-nav bg-gradient-success sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                ...
                <div id="collapseThree" class="collapse" aria-labelledby="headingThree" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="cetak_laporan2a.php">Cetak Laporan 2.A</a>
                        <a class="collapse-item" href="cetak_laporan2b.php">Cetak Laporan 2.B</a>
                        <a class="collapse-item" href="cetak_laporan2c.php">Cetak Laporan 2.C</a>
                        <a class="collapse-item" href="cetak_laporan3a.php">Cetak Laporan 3.A</a>
                        <a class="collapse-item" href="cetak_laporan3b.php">Cetak Laporan 3.B</a>
                    </div>
                </div>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="panel">
                        ...
                        <h4 class="page-header fw-bolder"><i class="fa fa fa-bars fw-bolder"></i> CETAK LAPORAN</h4>
                        </div>
                        <div class="panel-body">
                        <hr>
                        <div class="row">
                            <div class="col-md-4">
                                <select class="form-select select2" aria-label="Default select example" onchange="showHideForm()" id="comboBox" style="width: 330px;">
                                    <option value="show">Tampilkan Form</option>
                                    <option value="hide">Sembunyikan Form</option>
                                </select>
                            </div>
                            
                            <!-- <div class="col-md-4">
                                <select id="cetak_dropdown" class="form-select select2" aria-label="Default select example" style="width: 330px;" onchange=" if (this.selectedIndex==1){ document.getElementById('tampil_form2a').style.display = 'inline'} else if(this.selectedIndex==2){document.getElementById('tampil_form2b').style.display = 'inline'} else if(this.selectedIndex==3){document.getElementById('tampil_form2c').style.display = 'inline'} else if(this.selectedIndex==4){document.getElementById('tampil_form3a').style.display = 'inline'} else if(this.selectedIndex==5){document.getElementById('tampil_form3b').style.display = 'inline'} else if(this.selectedIndex==6){document.getElementById('tampil_form4').style.display = 'inline'} else if(this.selectedIndex==7){document.getElementById('tampil_form_bcpl').style.display = 'inline'}">
                                    <option >--Pilih File--</option>
                                    <option value="cetak_formulir2a.php">Cetak Laporan 2A</option>
                                    <option value="cetak_formulir2b.php">Cetak Laporan 2B</option>
                                    <option value="cetak_formulir2c.php">Cetak Laporan 2C</option>
                                    <option value="cetak_formulir3a.php">Cetak Laporan 3A</option>
                                    <option value="cetak_formulir3b.php">Cetak Laporan 3B</option>
                                </select>
                            </div> -->
                            <!-- <div class="col-md-4">
                                <button class="btn btn-info" onclick="myFunc()">Pilih</button>
                            </div> -->
                        </div>
                        
                        <br>
                        <span id="tampil_form2a" style="display: none;">
                            <form action="cetak_formulir2a.php" method="post" target="_blank">
                                <table>
                                <tr>
                                    <td>Bulan</td>
                                    <td>: 
                                ...
                                <tr>
                                    <td align="left" style="padding-top:20px;"><button type="submit" name="cetak" class="btn btn-success btn-sm"><i class="fa fa fa-print"></i> Cetak Laporan</a></td>
                                </tr>
                        ...
                        <span id="tampil_form2b" style="display: none;">
                        ...
                        <span id="tampil_form2c" style="display: none;">
                        ...
                        <span id="tampil_form3a" style="display: none;">
                            <form action="cetak_formulir3a.php" method="post" id="form_cetak" target="_blank">
                                <table>
                                <tr>
                                    <td>Bulan Pertama</td>
                                    <td>: 
                                ...
                                <tr>
                                    <td>Sampai Bulan</td>
                                    <td>: 
                                        <select class="select2" name="bulan2" id="bulan2" style="width: 193px;">
                                            <option value="1">Januari</option>
                                            <option value="2">Februari</option>
                                            <option value="3">Maret</option>
                                            <option value="4">April</option>
                        ...
                        <span id="tampil_form3b" style="display: none;">
                            <form action="cetak_formulir3b.php" method="post" id="form_cetak" target="_blank">
                                <table>
                                <tr>
                                    <td>Bulan Pertama</td>
                                    <td>: 
    ...
    <script>
        function showHideForm() {
            ...
            var form = document.getElementById("tampil_form2a");
    ...
    <script>
        function showHideForm() {
            var comboBox = document.getElementById("comboBox");
            var selectedOption = comboBox.options[comboBox.selectedIndex].value;
            var form = document.getElementById("tampil_form2b");
            if (selectedOption == "show") {
                form.style.display = "block";
            } else {
                form.style.display = "none";
    ...
    <!-- <script>
        function myFunc(){
            ...
            var dropdown = document.getElementById("cetak_dropdown");

            // mendapatkan nilai yang dipilih dari dropdown
            var selectedValue = dropdown.options[dropdown.selectedIndex].value;

            // mendapatkan elemen HTML yang akan menerima input dari dropdown
            var targetElement = document.getElementById("cetak");

            // menetapkan nilai yang dipilih dari dropdown ke atribut HTML yang diinginkan
            targetElement.setAttribute("href", selectedValue);
        }
    </script> -->
