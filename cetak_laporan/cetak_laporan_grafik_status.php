...
<head>
    ...
    <title>SIMPELPRES - Cetak Laporan Grafik Status Gizi Anak</title>
                    ...
                    <div class="col-lg-12">
                        <div class="card mb-4 mt-2">
                            <div class="card-header py-3">
                                <h6 class="m-0 font-weight-bold text-uppercase">CETAK LAPORAN GRAFIK STATUS GIZI ANAK</h6>
                            </div>
                            <div class="card-body">
                                <form action="cetak_formulir_grafik_status.php" method="post" target="_blank">
                                    <table>
                                    <tr>
                                        <td>Bulan</td>
                                        <td>: 
