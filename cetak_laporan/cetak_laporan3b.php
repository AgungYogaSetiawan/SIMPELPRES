...
<head>
    ...
    <title>SIMPELPRES - Cetak Laporan 3B</title>
                    ...
                    <div class="col-lg-12">
                        <div class="card mb-4 mt-2">
                            <div class="card-header py-3">
                                <h6 class="m-0 font-weight-bold">CETAK LAPORAN 3B REKAPITULASI HASIL PEMANTAUAN 3 (TIGA) BULANAN BAGI ANAK 0-2 TAHUN</h6>
                            </div>
                            <div class="card-body">
