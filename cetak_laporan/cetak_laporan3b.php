...
<head>
    ...
    <title>SIMPELKPM - Cetak Laporan 3B</title>
            ...
            <li class="nav-item">
                ...
                <div id="collapseThree" class="collapse" aria-labelledby="headingThree" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="" data-toggle="tooltip" data-placement="top" title="Data Rekapitulasi Tiga Bulanan Bagi Anak 0-2 Tahun">Cetak Laporan 3.B</a>
                    </div>
                </div>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="panel">
                        ...
                        <h4 class="page-header fw-bolder"><i class="fa fa fa-bars fw-bolder"></i> CETAK LAPORAN 3B REKAPITULASI HASIL PEMANTAUAN 3 (TIGA) BULANAN BAGI ANAK 0-2 TAHUN</h4>
                        </div>
