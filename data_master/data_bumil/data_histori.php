...
<head>  
    ...
    <title>SIMPELKPM - Data Histori Ibu Hamil</title>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <section id="main-content">
                        ...
                        <a href="data_bumil.php" class="btn btn-secondary btn-sm"><i class="fa fa fa-arrow-left"></i> Kembali</a>
                        <div class="card mb-4 mt-2">
                            <div class="card-header py-3">
                                <h6 class="m-0 font-weight-bold">Data Histori Ibu Hamil</h6>
                            </div>
                            <div class="card-body">
                                <div class="table-responsive">
                                    ...
                                    <tbody>
                                        ...
                                        $query = mysqli_query($konek, "SELECT * FROM tb_log_bumil lb INNER JOIN tb_bumil tb ON lb.id_bumil=tb.id_bumil WHERE tb.id_bumil='$id_bumil'");
                                        $no = 1;
