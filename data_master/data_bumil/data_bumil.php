...
<head>  
    ...
    <title>SIMPELKPM - Data Ibu Hamil</title>
            ...
            <li class="nav-item">
                ...
                <div id="collapseOne" class="collapse" aria-labelledby="headingOne" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="">Data Ibu Hamil</a>
                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered" id="tabel" width="100%" cellspacing="0">
                                        ...
                                        <tbody>
                                            ...
                                            if($kel == 'admin'){
                                                $query = mysqli_query($konek, "SELECT * FROM tb_bumil");
                                            } else {
                                                $query = mysqli_query($konek, "SELECT * FROM tb_bumil WHERE kelurahan='$kel'");
                                            }
                                            $no = 1;
                                            ...
                                            <tr>
                                                ...
                                                <td align="center"><?php echo $row['usia_kehamilan']; ?></td>
                                                <?php
                                                echo "
                                                <td>";
