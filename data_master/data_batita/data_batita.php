...
<head>  
    ...
    <title>SIMPELKPM - Data Anak 0-2 Tahun</title>
            ...
            <li class="nav-item">
                ...
                <div id="collapseOne" class="collapse" aria-labelledby="headingOne" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="">Data Anak 0-2 Tahun</a>
                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered" id="tabel" width="100%" cellspacing="0">
                                        ...
                                        <tbody>
                                            ...
                                            if($kel == 'admin'){
                                                $query = mysqli_query($konek, "SELECT * FROM tb_baduta");
                                            } else {
                                                $query = mysqli_query($konek, "SELECT * FROM tb_baduta WHERE kelurahan='$kel'");
                                            }
                                            $no = 1;
                                            ...
                                            <tr>
                                                ...
                                                <td align="center"><?php echo $row['status_gizi_anak']; ?></td>
