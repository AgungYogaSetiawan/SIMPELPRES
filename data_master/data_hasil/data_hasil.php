...
<head>  
    ...
    <title>SIMPELPRES - Data Hasil</title>
                    ...
                    <section id="main-content">
                        ...
                        <div class="card mb-4 mt-2">
                            <div class="card-header py-3">
                                <h6 class="m-0 font-weight-bold">Data Hasil</h6>
                            </div>
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table table-bordered" id="tabel" width="100%" cellspacing="0">
                                        <thead style="background-color: #1ABA80; color: white;">
                                            <tr>
                                                <th>No</th>
                                                <th>Hasil (Merah/Kuning/Hijau)</th>
                                                <th>Aksi</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <div class='btn-group'>
                                                <a href='edit_data.php?id_hasil=$row[0]' class='btn btn-warning btn-sm mr-2'><i class='fa fa fa-pen'></i></a>
                                                <a href='hapus_data.php?id_hasil=$row[0]' class='btn btn-danger btn-sm mr-2 alert_hapus'><i class='fa fa fa-trash'></i></a>";
                                                echo"</div>
                                                </div>
                                                </td>
                                                ";
