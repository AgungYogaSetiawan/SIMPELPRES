<?php
    ...
    if(isset($_POST['tambah'])){
        $hasil = $_POST['hasil'];
        $sql = "INSERT INTO tb_hasil VALUES (NULL, '$hasil')";

        $database = new Database();
        $connection = $database->getConnection();
        $statement = $connection->prepare($sql);
        $statement->bindParam(1, $hasil);
        $statement->execute();
                        ...
                        <section class="wrapper">
                            <div class="card mb-4 mt-2">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold">Tambah Data Hasil</h6>
                                </div>
                                <div class="card-body">
                                        <br>
                                                ...
                                                <div class="col">
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-10 mt-2">
                                                            <input type="text" class="form-control" name="hasil" id="hasil" placeholder="Masukkan Hasil" style="width: 250px;">
                                                        </div>
                                                    </div>
                                                    <!-- end no register -->
                                                </div>
