...
<head>  
    ...
    <title>SIMPELPRES - Data Status Kehamilan</title>
                    ...
                    <section id="main-content">
                        ...
                        <div class="card mb-4 mt-2">
                            <div class="card-header py-3">
                                <h6 class="m-0 font-weight-bold">Data Status Kehamilan</h6>
                            </div>
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table table-bordered" id="tabel" width="100%" cellspacing="0">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td><?php echo $no++ ?></td>
                                                <td><?php echo $row['status_kehamilan']; ?></td>
                                                <?php
                                                echo "
                                                <td>";
                                                echo "<div class='btn-row'>
                                                <div class='btn-group'>
                                                <a href='edit_data.php?id_status_kehamilan=$row[0]' class='btn btn-warning btn-sm mr-2'><i class='fa fa fa-pen'></i></a>
                                                <a href='hapus_data.php?id_status_kehamilan=$row[0]' class='btn btn-danger btn-sm mr-2 alert_hapus'><i class='fa fa fa-trash'></i></a>";
                                                echo"</div>
                                                </div>
                                                </td>
                                                ";
