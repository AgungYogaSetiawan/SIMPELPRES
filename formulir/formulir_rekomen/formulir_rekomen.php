...
<head>
    ...
    <title>SIMPELPRES - Data Laporan Rekomendasi Intervensi</title>
    ...
    <style>
        .limited-height {
            max-height: 50px; /* Atur ketinggian maksimal sesuai kebutuhan */
            overflow: hidden;
        }
    </style>
                ...
                <div class="container-fluid">
                    ...
                    <section id="main-content">
                        <section class="wrapper">
                            <div class="mb-5">
                                <div class="row">
                                    ...
                                    <form action="<?php echo $_SERVER["PHP_SELF"];?>" method="POST">
                                        ...
                                        <a href="formulir_rekomen.php" class="btn btn-secondary btn-sm mt-2"><i class="fa fa fa-sync"></i> Refresh</a>
                                    </form>
                                    <!-- end form pencarian -->
                                </div>
                            </div>
                            ...
                            <?php } ?>
                            <a href="../../cetak_laporan/cetak_laporan_rekomendasi.php" class="btn btn-warning btn-sm"><i class="fa fa fa-print"></i> Cetak</a>
                            <div class="card mb-4 mt-2">
                            <div class="card-header py-3">
                                <h6 class="m-0 font-weight-bold">Data Rekomendasi Intervensi Pencegahan Stunting</h6>
                            </div>
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table table-stripped table-bordered mt-3 table-responsive" style="width:100%; border-collapse:collapse;">
                                    ...
                                    <tbody>
                                        ...
                                        if(isset($_POST['cari'])){
                                            ...
                                            $query = mysqli_query($konek, "SELECT r.*, f.*, b.*, g.status_gizi, h.hasil, p.deskripsi FROM tb_intervensi r, tb_formulir2b f, tb_baduta b, tb_gizi_anak g, tb_hasil h, tb_pencegahan p WHERE r.id_formulir_duaB=f.id_formulir_duaB AND f.id_baduta=b.id_baduta AND b.id_gizi_anak=g.id_gizi_anak AND b.id_hasil=h.id_hasil AND g.status_gizi = 'STUNTING' GROUP BY r.id_formulir_duaB LIMIT $halaman_awal, $batas");
                                            $query_halaman = mysqli_query($konek, "SELECT r.*, f.*, b.*, g.status_gizi, h.hasil, p.deskripsi FROM tb_intervensi r, tb_formulir2b f, tb_baduta b, tb_gizi_anak g, tb_hasil h, tb_pencegahan p WHERE r.id_formulir_duaB=f.id_formulir_duaB AND f.id_baduta=b.id_baduta AND b.id_gizi_anak=g.id_gizi_anak AND b.id_hasil=h.id_hasil AND g.status_gizi = 'STUNTING'");
                                            $jumlah_data = mysqli_num_rows($query_halaman);
				                            $total_halaman = ceil($jumlah_data / $batas);
                                        } else if($stat == 'kpm'){
                                            $query = mysqli_query($konek, "SELECT r.*, f.*, b.*, g.status_gizi, h.hasil, p.deskripsi FROM tb_intervensi r, tb_formulir2b f, tb_baduta b, tb_gizi_anak g, tb_hasil h, tb_pencegahan p WHERE r.id_formulir_duaB=f.id_formulir_duaB AND f.id_baduta=b.id_baduta AND b.id_gizi_anak=g.id_gizi_anak AND b.id_hasil=h.id_hasil AND g.status_gizi = 'STUNTING' AND b.kelurahan = '$kel' GROUP BY r.id_formulir_duaB LIMIT $halaman_awal, $batas");
                                            $query_halaman = mysqli_query($konek, "SELECT r.*, f.*, b.*, g.status_gizi, h.hasil, p.deskripsi FROM tb_intervensi r, tb_formulir2b f, tb_baduta b, tb_gizi_anak g, tb_hasil h, tb_pencegahan p WHERE r.id_formulir_duaB=f.id_formulir_duaB AND f.id_baduta=b.id_baduta AND b.id_gizi_anak=g.id_gizi_anak AND b.id_hasil=h.id_hasil AND g.status_gizi = 'STUNTING' AND b.kelurahan = '$kel' GROUP BY r.id_formulir_duaB");
                                            $jumlah_data = mysqli_num_rows($query_halaman);
				                            $total_halaman = ceil($jumlah_data / $batas);
                                        }
                                        ...
                                        <tr>
                                            ...
                                            ?></td>
                                            <td class="limited-height" style="max-width:300px; padding:8px;">
                                                <?php
                                            ...
                                            <div class='btn-group'>
                                            <a href='edit_data.php?id=$row[0]&id2=$row[1]' class='btn btn-warning btn-sm mr-2'><i class='fa fa fa-pen'></i></a>
                                            <a href='hapus_data.php?id=$row[0]&id2=$row[1]' class='btn btn-danger btn-sm mr-2 alert_hapus'><i class='fa fa fa-trash'></i></a>";
                                            }
                                            echo"</div>
                                            </div>
                                            </td>";
