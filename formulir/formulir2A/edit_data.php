...
$sql = "SELECT * FROM tb_formulir2a f INNER JOIN tb_bumil b ON f.id_bumil=b.id_bumil WHERE f.id_formulir_duaA='$id_formulir_duaA'";
...
if(isset($_POST['edit'])){
    ...
    $sql = "UPDATE tb_formulir2a SET pemeriksaan_kehamilan = '$pemeriksaan_kehamilan', dapat_pilfe = '$dapat_pilfe', pemeriksaan_nifas = '$pemeriksaan_nifas', konseling_gizi = '$konseling_gizi', kunjungan_rumah = '$kunjungan_rumah', kepem_air_bersih = '$kepem_air_bersih', kepem_jamban = '$kepem_jamban', jamkes = '$jamkes' WHERE id_formulir_duaA = '$id_formulir_duaA'";
...
<head>
    ...
    <title>Laporan 2.A - Edit Data</title>
                ...
                <div class="container-fluid">
                    ...
                    <div class="card mb-4 mt-2">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold">Edit Data Laporan 2A Pemantauan Bulanan Ibu Hamil</h6>
                        </div>
                        <div class="card-body">
                            <form action="" method="POST">
                                <input type="hidden" id="id_formulir_duaA" name="id_formulir_duaA" value="<?php echo $data['id_formulir_duaA']; ?>" readonly>
                                <div class="row">
                                            <div class="col">
                                                <!-- kelurahan -->
                                        ...
                                        <div class="row">
                                            <div class="col">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-10 mt-2">
                                                        <select class="form-select select2" name="id_status_kehamilan" id="id_status_kehamilan" style="width: 250px;" disabled>
                                                        <?php 
                                                        include '../../setting/koneksi.php';
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10 mt-2">
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" value="Y" name="pemeriksaan_kehamilan" id="pemeriksaan_kehamilan" <?php echo ($data['pemeriksaan_kehamilan'] == 'Y') ? " checked" : "" ?> required>
                                                    <label class="form-check-label" for="pemeriksaan_kehamilan">
                                                        Y
                                                    </label>
                                                </div>
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" value="T" name="pemeriksaan_kehamilan" id="pemeriksaan_kehamilan2" <?php echo ($data['pemeriksaan_kehamilan'] == 'T') ? " checked" : "" ?> required>
                                                    <label class="form-check-label" for="pemeriksaan_kehamilan2">
                                                        T
                                                    </label>
                                                </div>
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" value="TS" name="pemeriksaan_kehamilan" id="pemeriksaan_kehamilan3" <?php echo ($data['pemeriksaan_kehamilan'] == 'TS') ? " checked" : "" ?> required>
                                ...
                                <div class="row">
                                    <div class="col">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10 mt-2">
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" value="Y" name="pemeriksaan_nifas" id="pemeriksaan_nifas" <?php echo ($data['pemeriksaan_nifas'] == 'Y') ? " checked" : "" ?> required>
                                                    <label class="form-check-label" for="pemeriksaan_nifas">
                                                        Y
                                                    </label>
                                                </div>
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" value="T" name="pemeriksaan_nifas" id="pemeriksaan_nifas2" <?php echo ($data['pemeriksaan_nifas'] == 'T') ? " checked" : "" ?> required>
                                                    <label class="form-check-label" for="pemeriksaan_nifas3">
                                                        T
                                                    </label>
                                                </div>
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" value="TS" name="pemeriksaan_nifas" id="pemeriksaan_nifas2" <?php echo ($data['pemeriksaan_nifas'] == 'TS') ? " checked" : "" ?> required>
                                                    <label class="form-check-label" for="pemeriksaan_nifas3">
                                                        TS
                                                    </label>
                                                </div>
                                    ...
                                    <div class="col">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10 mt-2">
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" value="Y" name="dapat_pilfe" id="dapat_pilfe" <?php echo ($data['dapat_pilfe'] == 'Y') ? " checked" : "" ?> required>
                                                    <label class="form-check-label" for="dapat_pilfe">
                                                        Y
                                                    </label>
                                                </div>
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" value="T" name="dapat_pilfe" id="dapat_pilfe2" <?php echo ($data['dapat_pilfe'] == 'T') ? " checked" : "" ?> required>
                                                    <label class="form-check-label" for="dapat_pilfe2">
                                                        T
                                                    </label>
                                                </div>
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" value="TS" name="dapat_pilfe" id="dapat_pilfe3" <?php echo ($data['dapat_pilfe'] == 'TS') ? " checked" : "" ?> required>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10 mt-2">
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" value="Y" name="konseling_gizi" id="konseling_gizi" <?php echo ($data['konseling_gizi'] == 'Y') ? " checked" : "" ?> required>
                                                    <label class="form-check-label" for="konseling_gizi">
                                                        Y
                                                    </label>
                                                </div>
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" value="T" name="konseling_gizi" id="konseling_gizi2" <?php echo ($data['konseling_gizi'] == 'T') ? " checked" : "" ?> required>
                                                    <label class="form-check-label" for="konseling_gizi2">
                                                        T
                                                    </label>
                                                </div>
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" value="TS" name="konseling_gizi" id="konseling_gizi3" <?php echo ($data['konseling_gizi'] == 'TS') ? " checked" : "" ?> required>
                                    ...
                                    <div class="col">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10 mt-2">
                                                ...
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" value="T" name="kepem_jamban" id="kepem_jamban2" <?php echo ($data['kepem_jamban'] == 'T') ? " checked" : "" ?> required>
